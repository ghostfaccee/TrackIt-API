...
@router.post('/log/{habit_id}', response_model = LogResponse, status_code = status.HTTP_201_CREATED, summary = 'Create a log', description = 'Creates a completion mark for the specified habit.')
@limiter.limit('1/day')
...
@router.delete('/log/{log_id}', status_code = status.HTTP_204_NO_CONTENT, summary = 'Delete a log', description = 'Deletes the current mark associated with the habit.')
