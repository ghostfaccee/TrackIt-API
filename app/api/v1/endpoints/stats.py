...
from app.dependencies import get_stats_service, get_current_user
...
@router.get('/stats/{habit_id}', response_model = StatsResponse, summary = 'Statistics on a specific habit', description = 'Returns how many days the user has marked it, the current streak, and the last mark.')
